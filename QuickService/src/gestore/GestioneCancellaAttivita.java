...
public class GestioneCancellaAttivita {
	
	private ArrayList<Attivita> attivita;
	private JTable TableAttivita;
	private Utente ut;
	 public GestioneCancellaAttivita  (Utente u)
	{
	 ut=u;
         UtilGC gc = new UtilGC();
	 final JFrame frmFinestraGS = new JFrame("Albergo - Seleziona Attivita Da Cancellare");  //  @jve:decl-index=0:visual-constraint="135,33"
		 ...
		 public void mouseClicked(MouseEvent evt) {
			...
			private void ModificaSalaButtonMouseClicked(MouseEvent evt)throws SQLException {
				...
				if (riga == -1 ){
					...
					GestioneCancellaAttivita1  mod= new GestioneCancellaAttivita1 (ut,s);
