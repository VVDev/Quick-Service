...
public class GestioneCancellaAttivita1 {
    private Utente ut;
    private Attivita attivita;
	 public GestioneCancellaAttivita1(Utente u,Attivita s)
		{
                 ut=u;
                 attivita = s;
                 UtilGC gc = new UtilGC();
		 final JFrame finestra = new JFrame("Gestione Cinema - Cancella un attivita");  //  @jve:decl-index=0:visual-constraint="135,33"
      ...
      final JButton btnModifica = new JButton("Cancella Attivita");
		...
		public void actionPerformed(ActionEvent e ){
			 ...
			 if (btn== btnModifica ){
				...
				try{
					...
					db.CancellaAttivita(Integer.valueOf(txtIDAttivita.getText().valueOf(attivita.getID())));
                                        JOptionPane.showMessageDialog(null,"Cancellazzione eseguita correttamente ");
					GestioneCancellaAttivita gest = new GestioneCancellaAttivita(ut);
                                        finestra.dispose();
				 ...
				 GestioneCancellaAttivita gestione =new GestioneCancellaAttivita (ut);
                                  finestra.dispose();
			 }
		}
	};
